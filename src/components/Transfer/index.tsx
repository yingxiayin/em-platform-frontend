...
import { Button, Dropdown, Menu, Card, Popover, Tag, List, Row, Col, message, Tooltip } from 'antd';
import {
  OrderedListOutlined,
  ZoomInOutlined,
  RedoOutlined,
    ...
    <Row>
      <Col span={10}>
        <div className={styles.left}>
          ...
          <div className={styles.image}>
            <div className={styles.image_transfer}>
              {transferUrl !== '0' ? (
                ...
                <div className={styles.image_text}>Please upload your draft (content image)</div>
              )}
            </div>
          </div>
          ...
          <a href={transferUrl} download="transfer-res">
            <Button
      ...
      <Col span={14}>
        <div className={styles.right}>
          <Button type="primary" className={styles.right_area_text}>
            <OrderedListOutlined />
                      ...
                      >
                        {cardSelectedId === item.id ? (
                          <Card
                            ...
                            cover={
                              <div>
                                <img className={styles.card_image} src={item.url} alt="style" />
                              </div>
                            }
                          />
                        ) : (
